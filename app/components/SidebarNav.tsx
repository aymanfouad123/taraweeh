...
export default function SidebarNav({
  ...
  return (
    ...
    >
      ...
      {/* Fixed-slot verse rows — DOM never changes, only content updates */}
          ...
          return (
            <li key={offset}>
              <motion.button
                ...
                aria-current={isActive && inBounds ? "true" : undefined}
              ...
              >
                ...
                <motion.span
                  ...
                  animate={{
                    width: isActive && inBounds ? 14 : 5,
                    opacity: isActive && inBounds ? 1 : 0.3,
                  }}
                ...
                <motion.span
                  ...
                  animate={{
                    color: isActive && inBounds
                      ? "rgba(255,255,255,1)"
                      : "rgba(255,255,255,0.4)",
                    fontSize: isActive && inBounds ? "12px" : "11px",
                  }}
                  transition={{ duration: 0.18 }}
                >
